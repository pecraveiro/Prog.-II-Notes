...
int main()
{
    ...
    {
        cout << "Database file not found. Creating a new txt file. Welcome." << endl;
    }
    ...
    while(true) //main loop
    {
        ...
        if(ch == '0')
        {
            if(SaveDatabase("database.txt", ListOfWords) == false)
            {
                cout << "Error, unable to save the database." << endl;
            }
            else
                break;
        }
